...
instance Print (AbsLatte.Program' a) where
  prt i = \case
    AbsLatte.Program _ defs -> prPrec i 0 (concatD [prt 0 defs])

instance Print (AbsLatte.Def' a) where
  prt i = \case
    AbsLatte.DefFunc _ type_ id_ args block -> prPrec i 0 (concatD [prt 0 type_, prt 0 id_, doc (showString "("), prt 0 args, doc (showString ")"), prt 0 block])
    AbsLatte.DefClass _ id_ extend features -> prPrec i 0 (concatD [doc (showString "class"), prt 0 id_, prt 0 extend, doc (showString "{"), prt 0 features, doc (showString "}")])
...
instance Print (AbsLatte.Extend' a) where
  prt i = \case
    AbsLatte.NoExtend _ -> prPrec i 0 (concatD [])
    AbsLatte.Extend _ id_ -> prPrec i 0 (concatD [doc (showString "extends"), prt 0 id_])

instance Print (AbsLatte.Feature' a) where
  prt i = \case
    AbsLatte.Atribute _ type_ items -> prPrec i 0 (concatD [prt 0 type_, prt 0 items, doc (showString ";")])
...
instance Print (AbsLatte.Stmt' a) where
  prt i = \case
    ...
    AbsLatte.SBlock _ block -> prPrec i 0 (concatD [prt 0 block])
...
instance Print (AbsLatte.Expr' a) where
  prt i = \case
    AbsLatte.EVar _ id_ -> prPrec i 8 (concatD [prt 0 id_])
    AbsLatte.EApp _ id_ exprs -> prPrec i 8 (concatD [prt 0 id_, doc (showString "("), prt 0 exprs, doc (showString ")")])
    AbsLatte.EArrayVal _ expr1 expr2 -> prPrec i 8 (concatD [prt 8 expr1, doc (showString "["), prt 0 expr2, doc (showString "]")])
    AbsLatte.EFeature _ expr1 expr2 -> prPrec i 7 (concatD [prt 7 expr1, doc (showString "."), prt 8 expr2])
    ...
    AbsLatte.ELitString _ str -> prPrec i 6 (concatD [printString str])
    AbsLatte.Cast _ expr1 expr2 -> prPrec i 6 (concatD [doc (showString "("), prt 0 expr1, doc (showString ")"), prt 6 expr2])
    AbsLatte.NewArray _ type_ expr -> prPrec i 6 (concatD [doc (showString "new"), prt 0 type_, doc (showString "["), prt 0 expr, doc (showString "]")])
    AbsLatte.NewClass _ id_ -> prPrec i 6 (concatD [doc (showString "new"), prt 0 id_])
